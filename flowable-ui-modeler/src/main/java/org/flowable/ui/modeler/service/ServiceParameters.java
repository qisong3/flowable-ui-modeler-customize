...
public class ServiceParameters {
    ...
    /**
     * @return all valid parameters which are set in this instance. If no {@link #addValidParameterNames(String[])} has been called, ALL parameters will be returned.
     */
    ...
    /**
     * Creates a new {@link ServiceParameters} instance based on all non-empty query-parameters in the given request.
     */
